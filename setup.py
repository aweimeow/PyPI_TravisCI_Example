...
setup(
  ...
  version = '0.1',
  description = 'This is an example for how to build project onto PyPI & TravisCI',
  author = 'aweimeow(Wei-You Chen)',
  author_email = 'aweimemow.tw@gmail.com',
  url = 'https://github.com/aweimeow/PyPI_TravisCI_Example',
  download_url = 'https://github.com/aweimeow/PyPI_TravisCI_Example/archive/0.1.tar.gz',
